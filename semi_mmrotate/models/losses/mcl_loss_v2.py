...
class RotatedMCLLossV2(nn.Module):
    def __init__(self, cls_channels=16,thres = 0.02):
        super(RotatedMCLLossV2, self).__init__()
    ...
    def loss_single(self, t_logits_list, s_logits_list, level_inds):
        ...
        with torch.no_grad():
            ...
            selected_inds = torch.nonzero(max_vals > self.thres).squeeze(-1)
