...
class H2RV2Teacher(RotatedSemiDetector):
    ...
    def forward_train(self, imgs, img_metas, **kwargs):
        super(H2RV2Teacher, self).forward_train(imgs, img_metas, **kwargs)
        ...
        losses = dict()
        # supervised forward
        x = self.extract_feat(format_data['sup']['img'])
