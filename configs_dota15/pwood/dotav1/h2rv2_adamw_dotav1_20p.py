...
model = dict(
    type="H2RV2Teacher",
    model=detector,
    semi_loss=dict(type='RotatedMCLLossV2', cls_channels=16),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=1,  
        sup_weight=1.0,
...
common_pipeline = [
    ...
    dict(type='Collect', keys=['img', 'gt_bboxes', 'gt_labels'],
         meta_keys=('filename', 'ori_filename', 'ori_shape',
                    ...
                    'img_shape', 'pad_shape', 'scale_factor', 'img_norm_cfg', 'tag') 
         )
]
strong_pipeline = [
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            ...
            ann_file="data/dota_1_0/train_20p_labeled/annfiles/",
            img_prefix="data/dota_1_0/train_20p_labeled/images/",
            version=angle_version,
            classes=classes
        ),
        unsup=dict(
            ...
            ann_file="data/dota_1_0/train_20p_unlabeled/annfiles/",
            img_prefix="data/dota_1_0/train_20p_unlabeled/images/",
            version=angle_version,
            classes=classes,
    ...
    val=dict(
        ...
        img_prefix="dota1_0/val1/images/",
        ann_file='dota1_0/val1/annfiles/',
        version=angle_version,
        classes=classes
    ),
    test=dict(
        type=dataset_type,
        pipeline=test_pipeline,
        img_prefix="dota1_0/test/images/",
        ann_file='dota1_0/test/annfiles/',
        version=angle_version,
        classes=classes
...
custom_hooks = [
    ...
    dict(type="MeanTeacher", momentum=0, interval=1, start_steps=3200),  ###########
]
