...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            ...
            ann_file="data_dior/train_10p_labeled_txt/",
            img_prefix="data_dior/train_10p_labeled_jpg/",
            version=angle_version,
            classes=classes
        ),
        unsup=dict(
            ...
            ann_file="data_dior/train_10p_unlabeled_txt/",
            img_prefix="data_dior/train_10p_unlabeled_jpg/",
            version=angle_version,
            classes=classes,
