...
detector = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox=dict(type='mmdet.L1Loss', loss_weight=0.05),
        loss_overlap=dict(
...
model = dict(
    type="MCLTeacher",
    model=detector,
    semi_loss=dict(type='RotatedMCLLoss2', cls_channels=15),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=188000,
        sup_weight=1.0,
        unsup_weight=1.0,
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="dotav1/train_30p_labeled/annfiles/",
            img_prefix="dotav1/train_30p_labeled/images/",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup=dict(
            type=dataset_type,
            ann_file="dotav1/train_30p_unlabeled/annfiles/",
            img_prefix="dotav1/train_30p_unlabeled/images/",
            classes=classes,
