...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type=dataset_type,
            ann_file="dotav1/train_20p_labeled/annfiles/",
            img_prefix="dotav1/train_20p_labeled/images/",
            classes=classes,
            pipeline=sup_pipeline,
        ),
        unsup=dict(
            type=dataset_type,
            ann_file="dotav1/train_20p_unlabeled/annfiles/",
            img_prefix="dotav1/train_20p_unlabeled/images/",
            classes=classes,
