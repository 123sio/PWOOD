...
model = dict(
    type="MCLTeacher",
    model=detector,
    semi_loss=dict(type='RotatedMCLLoss2', cls_channels=18),
    train_cfg=dict(
        iter_count=0,
        burn_in_steps=12800,
        sup_weight=1.0,
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            ...
            ann_file="dotav2/train_30p_labeled/annfiles/",
            img_prefix="dotav2/train_30p_labeled/images/",
            version=angle_version,
            classes=classes
        ),
        unsup=dict(
            ...
            ann_file="dotav2/train_30p_unlabeled/annfiles/",
            img_prefix="dotav2/train_30p_unlabeled/images/",
            version=angle_version,
            classes=classes,
